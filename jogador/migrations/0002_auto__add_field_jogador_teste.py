...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Jogador.teste'
        db.add_column('jogador_jogador', 'teste',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Jogador.teste'
        db.delete_column('jogador_jogador', 'teste')
    ...
    models = {
        ...
        'jogador.jogador': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'teste': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
