...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Guidu.golpe_tempo_treinado'
        db.add_column('guidu_guidu', 'golpe_tempo_treinado',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Guidu.golpe_tempo_treinado'
        db.delete_column('guidu_guidu', 'golpe_tempo_treinado')
