...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GuiduTipo.img_triste'
        db.delete_column('guidu_guidutipo', 'img_triste')

        # Deleting field 'GuiduTipo.img_feliz'
        db.delete_column('guidu_guidutipo', 'img_feliz')

        # Deleting field 'GuiduTipo.img_entediado'
        db.delete_column('guidu_guidutipo', 'img_entediado')

        # Deleting field 'GuiduTipo.img_normal'
        db.delete_column('guidu_guidutipo', 'img_normal')


    def backwards(self, orm):
        # Adding field 'GuiduTipo.img_triste'
        db.add_column('guidu_guidutipo', 'img_triste',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'GuiduTipo.img_feliz'
        db.add_column('guidu_guidutipo', 'img_feliz',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'GuiduTipo.img_entediado'
        db.add_column('guidu_guidutipo', 'img_entediado',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)

        # Adding field 'GuiduTipo.img_normal'
        db.add_column('guidu_guidutipo', 'img_normal',
                      self.gf('django.db.models.fields.files.ImageField')(default=None, max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'guidu.guidu': {
            ...
            'banheiro': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '7'}),
            ...
            'diversao': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '5'}),
            ...
            'social': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '7'}),
