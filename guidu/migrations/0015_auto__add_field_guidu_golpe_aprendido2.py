...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guidu.golpe_aprendido2'
        db.add_column('guidu_guidu', 'golpe_aprendido2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['golpe.Golpe']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guidu.golpe_aprendido2'
        db.delete_column('guidu_guidu', 'golpe_aprendido2_id')
    ...
    models = {
        ...
        'guidu.guidu': {
            ...
            'higiene': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
            ...
            'social': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '4'}),
