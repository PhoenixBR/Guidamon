...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Guidu.teste_update'
        db.delete_column('guidu_guidu', 'teste_update')

        # Adding field 'Guidu.humor_update'
        db.add_column('guidu_guidu', 'humor_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 1, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Guidu.teste_update'
        db.add_column('guidu_guidu', 'teste_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Guidu.humor_update'
        db.delete_column('guidu_guidu', 'humor_update')
    ...
    models = {
        ...
        'guidu.guidu': {
            ...
            'banheiro': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
