...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guidu.golpe_aprendido1'
        db.add_column('guidu_guidu', 'golpe_aprendido1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['golpe.Golpe']),
                      keep_default=False)

        # Adding field 'Guidu.golpe_treinando_desde'
        db.add_column('guidu_guidu', 'golpe_treinando_desde',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Guidu.golpe_treinando_tempo_treinado'
        db.add_column('guidu_guidu', 'golpe_treinando_tempo_treinado',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guidu.golpe_aprendido1'
        db.delete_column('guidu_guidu', 'golpe_aprendido1_id')

        # Deleting field 'Guidu.golpe_treinando_desde'
        db.delete_column('guidu_guidu', 'golpe_treinando_desde')

        # Deleting field 'Guidu.golpe_treinando_tempo_treinado'
        db.delete_column('guidu_guidu', 'golpe_treinando_tempo_treinado')
    ...
    models = {
        ...
        'guidu.guidu': {
            ...
            'banheiro': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '4'}),
            ...
            'golpe_treinando_desde': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'golpe_treinando_tempo_treinado': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'social': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '8'}),
