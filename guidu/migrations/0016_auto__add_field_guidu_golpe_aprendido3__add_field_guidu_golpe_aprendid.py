...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guidu.golpe_aprendido3'
        db.add_column('guidu_guidu', 'golpe_aprendido3',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['golpe.Golpe']),
                      keep_default=False)

        # Adding field 'Guidu.golpe_aprendido4'
        db.add_column('guidu_guidu', 'golpe_aprendido4',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['golpe.Golpe']),
                      keep_default=False)

        # Adding field 'Guidu.golpe_aprendido5'
        db.add_column('guidu_guidu', 'golpe_aprendido5',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['golpe.Golpe']),
                      keep_default=False)

        # Adding field 'Guidu.golpe_treinando'
        db.add_column('guidu_guidu', 'golpe_treinando',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['golpe.Golpe']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guidu.golpe_aprendido3'
        db.delete_column('guidu_guidu', 'golpe_aprendido3_id')

        # Deleting field 'Guidu.golpe_aprendido4'
        db.delete_column('guidu_guidu', 'golpe_aprendido4_id')

        # Deleting field 'Guidu.golpe_aprendido5'
        db.delete_column('guidu_guidu', 'golpe_aprendido5_id')

        # Deleting field 'Guidu.golpe_treinando'
        db.delete_column('guidu_guidu', 'golpe_treinando_id')
