...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guidu.esta_morto'
        db.add_column('guidu_guidu', 'esta_morto',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guidu.esta_morto'
        db.delete_column('guidu_guidu', 'esta_morto')
    ...
    models = {
        ...
        'guidu.guidu': {
            ...
            'fome': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '5'}),
            'fome_update': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'higiene': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '2'}),
